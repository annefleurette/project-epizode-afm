                ...
                ?>
                    <li>
                        <article>
                            ...
                            <p><a href="index.php?action=displayEpisode&idseries=<?php echo $seriesId; ?>&number=<?php echo $allEpisodesPublished['number']; ?>&id=<?php echo $episodesPublishedList['id']; ?>&like=0">LIRE</a></p>
                        </article>
                    </li>
                <?php
                }
